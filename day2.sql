...
-- DML - DELETE - 
--DELETE FROM TABLO_ADİ --> TABLONUN TUM İÇERİNİ SİLER
...
--ismi kemal yasa olan satırı sılın

delete from ogrenciler where isim='Kemal Yasa';

--İSMİ NESİBE YILMAZ VE YA MUSTAFA BAK OLAN KAYITLARI SILELIM
...
TRUNCATE TABLE ögrenciler;
--DDL - Data Definition Lang.
--CREATE - ALTER - DROP
--ALTER TABLE --
--ALTER TABLE tabloda ADD, TYPE, SET, RENAME veya DROP COLUMS islemleri icin kullanilir
...
--personel tablosundan sirket stununu siliniz
alter table personel DROP column sirket;
--personel tablosundan sehir sutununu adını ulke yapalım
alter table personel RENAME column sehir to ulke;

--personel tablosunun adını isciler olarak degıstırelım
...
INSERT INTO calisanlar VALUES('10007', 'CAN', 5000, '2018-04-14'); --unıq ısım
...
INSERT INTO calisanlar VALUES( null, 'filiz ' ,12000, '2018-04-14'); -- null yazdık
